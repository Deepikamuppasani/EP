...
public class CRUDAPP {
	...
	Exception { 
	        PreparedStatement pstmt = con.prepareStatement("update students set sname = ? 
	where sid = ?"); 
	    ...
	    public static void deleteStudent(Connection con, int sid) throws Exception { 
	        PreparedStatement pstmt = con.prepareStatement("delete from students where sid 
	= ?"); 
	        pstmt.setInt(1, sid); 
	        pstmt.executeUpdate(); 
	    } 
